...
stfp.main = {
    ...
    showIntro : function () {
        ...
        var ctx  = stfp.main._showText("MARDITO MADURO", "lightblue", true, "black", 50),
            text = "Selecciona espacio para continuar ...",
        ...
        image.onload = function () {
            ...
            ctx.drawImage(image, -21, -25, 150, 150,
        ...
        image.src = "img/maduro.png";
    },

    showInstructions : function () {
        "use strict";

        var ctx  = stfp.main._showText("MARDITO MADURO.", "lightgreen", true, "black", 50),
        ...
        image.src = "img/maduro.png";
        image.onload = function () {
            ctx.drawImage(image, 0, 0, 94, 133,
    ...
    initEngine : function () {
        ...
        stfp.main._showText("MIRAFLORES " + stfp.stats.latest_map + " - Comienza la matanza", "blue", true);
    ...
    gameOver : function () {
        ...
        stfp.main._showText("Nawebona vladimir te mato MADURO", "red");
    ...
    gameFinished : function () {
        ...
        stfp.main._showText("Juego Terminado!", "cyan", true);
    ...
    _showStats : function () {
        ...
        alert("Maduritos Asesinados: "+ stfp.stats.panda_kills +
              "\nDiosdado Kills: " + stfp.stats.nazi_kills +
